...
const hy: typeof en = {
  ...
  // Leaderboard
  lb_title: "Վ.",
  lb_subtitle: "Լ. ս. XP-ով: Շ. գ.!",
  lb_you: "(դ.)",
  lb_noLearners: "Ս. Չ.",
  lb_noLearnersHint: "Ս. ս. #1!",
  lb_yourRank: "Ձ. Վ. — #{n}",
  ...
  settings_teacher: "Ո.",
  settings_student: "Ս.",
  settings_joined: "Մ. {date}",
  settings_saveError: "Ս. Ձ. Փ. Կ.",
  settings_lvDisplay: "Մ. {n}",
  settings_daysDisplay: "{n} օ.",
  settings_levelDisplay: "Մ. {n}",
