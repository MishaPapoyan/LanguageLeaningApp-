...
export default async function TrueFalsePage() {
  ...
  return (
    <div className="max-w-2xl animate-fade-up">
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold" style={{ color: "var(--text)" }}>True or False</h1>
        <p className="text-sm mt-1" style={{ color: "var(--text-2)" }}>Is the translation correct? Quick-fire judgement!</p>
      </div>
      <TrueFalse words={words} />
    </div>
  );
}
